...
$(document).ready(function() {    
    ...
    // $(".masterhead").css({height:a-40}),$(".masterhead-img").css("height",a),$(".masterhead-detector img").mouseleave(function(){$(".masterhead-img-hover").animate({height:a},200)})
